...
<form action="${pageContext.request.contextPath}/item/update/" method="post" enctype="multipart/form-data">
    <table class="table table-hover">
        ...
        <tr class="success">
            ...
            <td>
                <input type="text" class="form-control" name="productionDate" value="<fmt:formatDate value="${item.productionDate}" pattern='yyyy-MM-dd'/>" id="productionDate" data-options="{'type':'YYYY-MM-DD','beginYear':2010,'endYear':2088}" placeholder="请输入生产日期" />
            </td>
        </tr>
        <tr class="warning">
